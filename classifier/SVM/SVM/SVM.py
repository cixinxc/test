...
def calcError(svm, alpha_k):
    # print('is  ', multiply(svm.alphas, svm.train_y).T.shape, svm.kernelMat[:, alpha_k].shape)
...
def trainSVM(train_x, train_y, C, toler, maxIter, kernelOption=('linear', 1.0)):
